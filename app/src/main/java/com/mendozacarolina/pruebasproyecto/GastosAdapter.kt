...
class GastosAdapter(private val context: Activity, val arregloServicios: ArrayList<Servicio>) : RecyclerView.Adapter<GastosAdapter.ViewHolder>(){
    ...
    class ViewHolder(val view: View) : RecyclerView.ViewHolder(view){
        val textGastosServicio: TextView = view.findViewById(R.id.textGastosServicio)
        val textMontoGasto: TextView = view.findViewById(R.id.textMontoGasto)
        val textViewFecha: TextView = view.findViewById(R.id.textViewFecha)
        val imageGastosServicio: ImageView = view.findViewById(R.id.imageGastosServicio)
